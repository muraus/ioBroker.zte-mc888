 ...
 * @property {string} cmd raw field name in the router JSON
 * @property {string} id ioBroker state id (channel.state)
 * @property {string} name human readable name
 * @property {ioBroker.CommonType} type state type
 * @property {string} role ioBroker role
 * @property {string} [unit] optional unit string
 * @property {boolean} [hexToDec] additionally expose the hex value as a decimal sibling state
 */
...
const ALL_CMDS = [...FIELDS.map(f => f.cmd), CA_FIELDS.scellInfo, CA_FIELDS.scellSig];
